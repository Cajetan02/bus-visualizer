      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 max-w-7xl mx-auto">
        ...
        <div className="xl:col-span-2 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card className="p-6 border-border bg-card/50 backdrop-blur">
              <h2 className="text-lg font-bold font-mono text-cpu-control mb-4">Control Signals</h2>
              <ControlSignals currentPhase={currentPhase} isExecuting={isExecuting} />
            </Card>

            <Card className="p-6 border-border bg-card/50 backdrop-blur">
              <h2 className="text-lg font-bold font-mono text-phase-execute mb-4">Execution Progress</h2>
              <ExecutionProgress 
                currentPhase={currentPhase} 
                isExecuting={isExecuting}
        ...
        <div className="space-y-6">
          <Card className="p-6 border-border bg-card/50 backdrop-blur">
            <h2 className="text-lg font-bold font-mono text-cpu-register mb-4">CPU Registers</h2>
            <RegisterPanel currentPhase={currentPhase} isExecuting={isExecuting} />
          </Card>

          <Card className="p-6 border-border bg-card/50 backdrop-blur">
            <h2 className="text-lg font-bold font-mono text-cpu-memory mb-4">Memory Viewer</h2>
            <MemoryViewer currentPhase={currentPhase} />
          </Card>

          <Card className="p-6 border-border bg-card/50 backdrop-blur">
            <h2 className="text-lg font-bold font-mono text-secondary mb-4">Instruction Editor</h2>
            <InstructionEditor 
